...
const DialogHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-1.5 text-center text-lg font-medium sm:text-left",
      className,
    )}
    {...props}
  />
