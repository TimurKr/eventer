...
export type BusinessesDocumentType = ExtractDocumentTypeFromTypedRxJsonSchema<typeof schemaTyped>;
...
export const businessesSchema: RxJsonSchema<BusinessesDocumentType> = schemaLiteral;
